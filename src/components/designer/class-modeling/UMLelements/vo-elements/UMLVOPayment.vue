...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            className() {
                return 'org.uengine.uml.model.vo.payment.Class'
            },
            createNew(elementId, x, y, width, height, angle) {
                return {
                    _type: this.className(),
                    name: 'Payment',
                    namePascalCase: 'Payment',
                    nameCamelCase: 'payment',
                    fieldDescriptors: VODefinitions["Payment"],
                    operations: [],
                    elementView: {
                        '_type': this.className(),
                        'id': elementId,
