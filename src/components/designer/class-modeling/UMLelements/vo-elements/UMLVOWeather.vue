...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            className() {
                return 'org.uengine.uml.model.vo.weather.Class'
            },
            createNew(elementId, x, y, width, height, angle) {
                return {
                    _type: this.className(),
                    name: 'Weather',
                    namePascalCase: 'Weather',
                    nameCamelCase: 'weather',
                    fieldDescriptors: VODefinitions["Weather"],
                    operations: [],
                    elementView: {
                        '_type': this.className(),
                        'id': elementId,
