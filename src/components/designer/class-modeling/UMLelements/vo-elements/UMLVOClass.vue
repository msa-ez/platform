...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            className() {
                return 'org.uengine.uml.model.vo.Class'
            },
        ...
        mounted: function () {
            ...
            if(!me.value.elementView.titleH || !me.value.elementView.subEdgeH || !me.value.elementView.fieldH || !me.value.elementView.methodH) {
                me.setHeight()
            }
        },
        methods: {
