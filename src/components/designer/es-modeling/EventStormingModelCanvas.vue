                ...
                <div style="width: 100%; height: 100%">
                    <div class="canvas-panel" style="left: 0">
                        ...
                        <v-layout right>
                            ...
                            <div class="project-name-all-btn-box">
                                <slot name="top">
                                    <v-row>
                                        <v-row
                                                        ...
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div class="es-hide-monitoring">MONITORING</div>
                                                                </v-btn>
                                                            </div>
                                                        </template>
                                                    </v-menu>
                                    ...
                                    <div class="es-is-mobile">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <v-list>
                                                    <v-list-item v-for="( item, index ) in shareItems"
                                                        :key="index"
                                                        @click="functionSelect(item.title,index)"
                                                    >
                                                        <v-list-item-title>{{ item.title }}</v-list-item-title>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // openCodeWeb: [],
                // openCodeMerge: [],
                defaultTemplate: "https://github.com/msa-ez/template-posco",
                changedHashList: [],
        ...
        watch: {
            ...
            "projectName": _.debounce(function (newVal, oldVal) {
                ...
                if(!newVal){
                    me.projectNameHint = "Please enter Project Name"
        ...
        methods: {
            ...
            async _sanpshotModelForcely() {
                // 짧은 시간에 다중 호출 (stopEventStormingGeneration / onComplete /
                // onFailed / siteMap 완료 등이 race 로 겹치는 케이스) 시 list+pushObject
                // 가 매번 발사돼 브라우저가 freeze 되는 문제 → in-flight dedup.
