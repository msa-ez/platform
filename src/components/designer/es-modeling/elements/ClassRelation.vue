...
//                    this.value.name = 'Pub/Sub'
                ...
                } else if ((this.value.sourceElement._type.endsWith('Command') || this.value.sourceElement._type.endsWith('Policy')) && (this.value.targetElement._type.endsWith('Aggregate')  || this.value.targetElement._type.endsWith('View'))) {
                    this.value.name = this.value.name ? this.value.name : 'Req/Res'
                    style = {
                        "arrow-end": "block",
                        'font-size': 14,
