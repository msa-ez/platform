...
4. If the Bounded Context name is not in English, you will need to change it to an appropriate English name. ex) 고객 -> CustomerService
...
\`\`\`json
{
    "thoughtProcess": {
        "analysis": {
            "ddlAnalysis": "Explain how you analyzed the DDL structure and identified key entities and relationships",
            "boundedContextAnalysis": "Explain how you determined the appropriate bounded contexts and their relationships",
            "functionalRequirementAnalysis": "Explain how you interpreted the functional requirements and mapped them to necessary actions"
        },
        "decisions": {
            "aggregateDesign": "Explain your decisions about aggregate design, including property assignments and relationships",
            "eventFlow": "Explain the flow of events and commands you designed to fulfill the requirements",
            "dataTypeChoices": "Explain your choices for data types, especially for complex types like ValueObjects and Enumerations"
        }
    },
    "actions": [
        {
...
- Final Check
* All DDL properties must be mapped to appropriate Aggregates/ValueObjects/GeneralClasses
* All Korean names in the suggested structure must be translated to appropriate English names
* Each Event that causes state changes should have corresponding Commands in other contexts
* Complex data types (like Money, Email, etc.) should be used instead of primitive types where appropriate
* Each Aggregate should have clear boundaries and maintain data consistency
* All functional requirements must be addressed through Commands and Events
* Ensure proper event flow and state management across bounded contexts
