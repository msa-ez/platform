export const commandReadModelExtractorInput = {
    ...
    resultDevideBoundedContext: [
        {
            "name": "BookManagement",
            "role": "도서 등록, 상태 관리(대출가능/대출중/예약중/폐기), ISBN 중복 및 유효성 검증, 도서 폐기 등 도서의 전체 라이프사이클을 관리한다."
        },
        {
            "name": "LoanProcess",
            "role": "회원 인증 후 도서 대출, 반납, 연장, 예약 등 대출 관련 모든 프로세스를 관리한다. 도서 상태 변경 요청을 BookManagement에 전달한다."
        },
        {
            "name": "BookHistory",
            "role": "도서의 대출/반납/연장 및 상태 변경 이벤트 발생 시 이력을 자동으로 기록하고, 이력 조회 기능을 제공한다."
        },
        {
            "name": "ui",
