...
class AggregateGenerator extends JsonAIGenerator {
    ...
    createPrompt(){
        ...
        if(this.client.input.model){
            let codeGenerator = new CodeGeneratorCore({canvas: this.client.canvas})
            let convertedModel = codeGenerator.convertModelForCodeGen(this.client.input.model)
        ...
        Commands and events within aggregates of bounded context must exist at least once.
    ...
    createModel(text){
        ...
        try {
                        ...
                        modelValue["boundedContext"][key]["aggregates"].forEach(function (agg, aggIdx){
                            ...
                            if(agg["name"]){
                                ...
                                if(me.generateCnt == bcIdx){
                                    ...
                                    if(me.client.input.boundedContext.aggregates.length>1){
                                        me.modelElements[aggUuid].elementView.x = me.client.input.aggregate.elementView.x
                                        me.modelElements[aggUuid].elementView.y = me.client.input.aggregate.elementView.y
                                    }
            ...
            if(e.message =="No setting boundedContext."){
                return e.message;
            }
...
module.exports = AggregateGenerator;