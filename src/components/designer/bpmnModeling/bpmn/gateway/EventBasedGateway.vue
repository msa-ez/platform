<template>
    <div>
        ...
        >
            ...
            <geometry-circle :center="[49, 49]" :radius="30" :_style="{'stroke-width': 0.5}"></geometry-circle>
            <geometry-circle :center="[49, 49]" :radius="25" :_style="{'stroke-width': 0.5}"></geometry-circle>

            <sub-elements>
                <bpmn-state-animation :status="status" :type="type"></bpmn-state-animation>
                <geometry-polygon
                        :vertices="[[50,32],[32,48],[40,64],[60,64],[65,48]]"
                        :_style="{
                            'stroke-width': 1,
                        }"
                ></geometry-polygon>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            className(){
                return 'org.uengine.kernel.bpmn.EventBasedGateway'
            },
