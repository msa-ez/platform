...
<script>
    ...
    export default {
        mixins: [IBpmn],
        name: 'bpmn-escalation-intermediate-throw-event',
        props: {},
        component: {
        ...
        computed: {
            ...
            className() {
                return 'org.uengine.kernel.bpmn.EscalationIntermediateThrowEvent'
            },
