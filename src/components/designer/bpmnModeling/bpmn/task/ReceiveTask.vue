...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            className(){
                return 'org.uengine.kernel.bpmn.ReceiveTask'
            },
        ...
        data: function () {
            return {
                links: null,
                receive_image: location.pathname + ((location.pathname == '/' || location.pathname.lastIndexOf('/') > 0) ? 
                    '' : '/') + 'static/image/symbol/message.png'
            };
        },
        watch: {
